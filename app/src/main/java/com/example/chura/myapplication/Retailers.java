            ...
            public ViewHolder(View itemView) {
                ...
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        switch (position){
                            case 0:
//                                startActivity(new Intent(Retailers.this, PatientCaregiverList.class));
                                break;
                        case 1:
// startActivity(new Intent(Retailers.this, .class)
////                                        .putExtra("username",user_id)
////                                );
//
                                Toast.makeText(Retailers.this, "Coming soon", Toast.LENGTH_SHORT).show();
                                break;
                            case 2:
//                              startActivity(new Intent(Retailers.this, .class));
                                break;
